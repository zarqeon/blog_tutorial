<?php
	...
	$textarea = ($_POST["textarea"]);	// Deklarálja a $textarea változót, ami textarea mezőből postolt értékekkel egyenlő
	echo $_POST ["tags"];	// Kiechózza mi lett POST módszerrel elküldve a tags input mezőből
	$tags = ($_POST["tags"]);	// Deklarálja a $tags változót, ami a tags inputmezőből postolt értékekkel egyenlő
	...
	function validate($variable)	//deklarálja a validate nevű függvényt, és egy változót ad meg paraméternek
	{
		if(!empty($variable))	//A feltétel teljesül, ha a megadott változónak van értéke.
		{
			return true;	//ha teljesült a feltétel, "true" értéket ad vissza
		}

		return false;	//ha nem teljesült a feltétel, "false" értéket ad vissza
	}
